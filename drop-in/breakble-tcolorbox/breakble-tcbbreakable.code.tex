...
\def\tcb@comp@h@page{%
  ...
  \tcb@if@contains@nested@breakable{%
    \ifdim\tcb@h@page<\dimexpr\kvtcb@breakminlines\baselineskip+\tcb@h@padtitle+\kvtcb@boxsep*2+\kvtcb@top+\kvtcb@bottom\relax%
      \tcbdimto\tcb@h@page{\textheight}%
    \fi%
  }{}%
...
\newif\iftcb@nested@fullfirstfragment
\def\tcb@setbox@overfull{0pt}
\def\tcb@nested@retry@overfullthreshold{\kvtcb@breakminlines\baselineskip}
...
\def\tcb@nested@titleless@firstreserve{\numexpr2*\kvtcb@breakminlines\relax\baselineskip}
\def\tcb@nested@empty@titleless@firstreserve{\kvtcb@breakminlines\baselineskip}
\def\tcb@nested@tinypagefraction{.30}
\def\tcb@nested@titlelessfirstfragmentfraction{.94}
\def\tcb@nested@titlelessaftertitlelessfirstfragmentfraction{.88}
\def\tcb@nested@titledfirstfragmentfraction{.86}
\def\tcb@nested@titledaftertitlelessfirstfragmentfraction{.84}
...
\def\tcb@nested@calc@depth@headroom{%
  ...
  \ifnum\c@tcblayer>2\relax%
    \@tempcnta=\numexpr\c@tcblayer-2\relax%
    \@whilenum\@tempcnta>0\do{%
      \tcbdimto\tcb@nested@depth@headroom{\tcb@nested@depth@headroom+\baselineskip}%
...
\def\tcb@nested@breakable@restrict@hpage{%
  \tcb@if@nested@managedbreakable{%
    \tcb@nested@fullfirstfragmentfalse%
    ...
    \ifnum\c@tcbbreakpart=0\relax%
      ...
      \tcbdimto\tcb@temp{\@tempdimb-\@tempdima}%
      ...
      \fi%
      \ifdim\@tempdimb<\tcb@nested@tinypagefraction\textheight\relax%
        ...
        \fi%
        \tcb@nested@fullfirstfragmenttrue%
      \fi%
      \iftcb@nested@fullfirstfragment%
      \else%
        \ifx\kvtcb@title\@empty%
          \tcb@if@nested@emptybreakskin{%
            \tcbdimto\tcb@nested@temp{\tcb@nested@titlelessfirstfragmentfraction\textheight-\@tempdima-\tcb@nested@empty@titleless@firstreserve}%
          }{%
            \tcb@if@contains@nested@hastitle{%
              \tcbdimto\tcb@nested@temp{\tcb@nested@titledfirstfragmentfraction\textheight-\@tempdima-\tcb@nested@titleless@firstreserve-\tcb@nested@depth@headroom}%
            }{%
              \tcb@if@parent@hastitle{%
                \tcbdimto\tcb@nested@temp{\tcb@nested@titlelessfirstfragmentfraction\textheight-\@tempdima-\tcb@nested@titleless@firstreserve-\tcb@nested@depth@headroom}%
              }{%
                \tcbdimto\tcb@nested@temp{\tcb@nested@titlelessaftertitlelessfirstfragmentfraction\textheight-\@tempdima-\tcb@nested@titleless@firstreserve-\tcb@nested@depth@headroom-\baselineskip}%
              }%
            }%
          }%
        ...
        \else%
          \tcb@if@parent@hastitle{%
            \tcbdimto\tcb@nested@temp{\tcb@nested@titledfirstfragmentfraction\textheight-\@tempdima}%
          }{%
            \tcbdimto\tcb@nested@temp{\tcb@nested@titledaftertitlelessfirstfragmentfraction\textheight-\@tempdima}%
          }%
          \ifdim\tcb@temp>\tcb@nested@temp\relax%
            \let\tcb@temp=\tcb@nested@temp%
          \fi%

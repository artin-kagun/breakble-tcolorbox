...
\def\tcb@nested@breakable@restrict@hpage{%
  \tcb@if@nested@managedbreakable{%
    ...
    \ifnum\c@tcbbreakpart=0\relax%
      \tcbdimto\tcb@temp{\@tempdimb-\@tempdima-\kvtcb@breakminlines\baselineskip-3\baselineskip/2-\parskip}%
      \ifnum\c@tcblayer>2\relax%
        \tcbdimto\tcb@temp{\tcb@temp-\baselineskip/2}%
      \fi%
      \ifnum\c@tcblayer>3\relax%
        \tcbdimto\tcb@temp{\tcb@temp-\baselineskip/2}%
      \fi%
    \else%
